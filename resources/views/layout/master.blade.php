  ...
  <body>
        ...
        <ul class="d-flex align-items-center">
          <li class="nav-item dropdown pe-3">
            <a
              ...
              <span class="d-none d-md-block px-2">
                @yield('username')
              </span>
              <img
    ...
    <aside id="sidebar" class="sidebar">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link {{ Request::is('admin/mwcnu') ? 'active':'' }}" href="/admin/mwcnu">
            <div class="icon-nav">
              <?xml version="1.0" ?><svg height="25" viewBox="0 0 64 64" width="25" xmlns="http://www.w3.org/2000/svg"><title/><path d="M47.8,22.4l-3-4a.977.977,0,0,0-.547-.34A12.466,12.466,0,0,0,33,8.044V6a1,1,0,0,0-2,0V8.044A12.482,12.482,0,0,0,19.745,18.06a.977.977,0,0,0-.545.34l-3,4a1,1,0,0,0-.158.346A2.979,2.979,0,0,0,15,25v2a1,1,0,0,0,1,1h4V51H18a3,3,0,0,0-3,3v2a1,1,0,0,0,1,1H48a1,1,0,0,0,1-1V54a3,3,0,0,0-3-3H44V28h4a1,1,0,0,0,1-1V25a2.979,2.979,0,0,0-1.042-2.254A1,1,0,0,0,47.8,22.4ZM32,10a10.474,10.474,0,0,1,10.192,8H21.809A10.485,10.485,0,0,1,32,10ZM20.5,20h23L45,22H19ZM46,53a1,1,0,0,1,1,1v1H17V54a1,1,0,0,1,1-1H46ZM32.5,32.132a1,1,0,0,0-.992,0,10.306,10.306,0,0,0-4.575,9.011V51H22V28H42V51H37.071V41.143A10.306,10.306,0,0,0,32.5,32.132Zm2.575,9.011V51H28.929V41.143A8.592,8.592,0,0,1,32,34.222,8.636,8.636,0,0,1,35.071,41.143ZM47,26H17V25a1,1,0,0,1,1-1H46a1,1,0,0,1,1,1Z"/></svg>
            </div>
            <span>MWC NU</span>
          </a>
        </li>
         ...
         <li class="nav-item">
          <a class="nav-link {{ Request::is('admin/anak-ranting') ? 'active':'' }}" href="/admin/anak-ranting">
            <div class="icon-nav">
              <?xml version="1.0" ?><svg height="25" viewBox="0 0 64 64" width="25" xmlns="http://www.w3.org/2000/svg"><title/><path d="M44.435,51.164l-4.9-34.5a.984.984,0,0,0-.235-.492,3.992,3.992,0,0,0,.48-2.9c-.38-1.792-3.43-3.327-5.634-4.218a2.91,2.91,0,1,0-4.288,0c-2.2.891-5.254,2.426-5.634,4.218a3.991,3.991,0,0,0,.48,2.9.984.984,0,0,0-.235.492l-4.9,34.5A2.992,2.992,0,0,0,20.5,57h23a2.992,2.992,0,0,0,.935-5.836ZM42.392,51H38.1l-1.7-33.195h1.282ZM37.821,13.691a2.325,2.325,0,0,1-.742,2.114H35.805a7.439,7.439,0,0,0,.163-2.413,4.319,4.319,0,0,0-.449-1.486C36.822,12.6,37.733,13.271,37.821,13.691ZM32,6.2a.911.911,0,1,1-.91.911A.912.912,0,0,1,32,6.2Zm-1.976,7.38A5.849,5.849,0,0,1,32,10.639a5.849,5.849,0,0,1,1.976,2.936,5.336,5.336,0,0,1-.244,2.23H30.268A5.346,5.346,0,0,1,30.024,13.575Zm-.406,4.23H34.39l1.7,33.2H27.906l1.7-33.195Zm-3.439-4.114c.091-.429,1-1.1,2.306-1.794a4.33,4.33,0,0,0-.453,1.495,7.439,7.439,0,0,0,.163,2.413H26.919A2.314,2.314,0,0,1,26.179,13.691Zm.146,4.114h1.282L25.9,51H21.608ZM43.5,55h-23a1,1,0,0,1,0-2h23a1,1,0,0,1,0,2Z"/></svg>
            </div>
            <span>Anak Ranting</span>
          </a>
        </li>
        <li class="nav-heading">Institutions</li>
         <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link {{ Request::is('admin/banom') ? 'active':'' }}" href="/admin/banom">
            <div class="icon-nav">
              <?xml version="1.0" ?><svg height="25" viewBox="0 0 64 64" width="25" xmlns="http://www.w3.org/2000/svg"><title/><g><path d="M27.883,29.72a1,1,0,0,0-.992,0,6.538,6.538,0,0,0-2.918,5.7v10a1,1,0,0,0,1,1H29.8a1,1,0,0,0,1-1v-10A6.538,6.538,0,0,0,27.883,29.72ZM28.8,44.412H25.973v-9a4.788,4.788,0,0,1,1.414-3.562A4.784,4.784,0,0,1,28.8,35.416Z"/><path d="M37.109,29.72a1,1,0,0,0-.992,0,6.538,6.538,0,0,0-2.918,5.7v10a1,1,0,0,0,1,1h4.828a1,1,0,0,0,1-1v-10A6.536,6.536,0,0,0,37.109,29.72Zm.918,14.692H35.2v-9a4.788,4.788,0,0,1,1.414-3.562,4.784,4.784,0,0,1,1.414,3.562Z"/><path d="M46.5,52a2.966,2.966,0,0,0-.184-1h.934a1,1,0,0,0,0-2h-1.9V27h1.9a1,1,0,0,0,0-2h-.934a2.966,2.966,0,0,0,.184-1,3,3,0,0,0-3-3h-.281a12.529,12.529,0,0,0-8.267-6.638,3.5,3.5,0,1,0-5.9,0A12.548,12.548,0,0,0,20.78,21H20.5a3,3,0,0,0-3,3,2.966,2.966,0,0,0,.184,1H16.75a1,1,0,0,0,0,2h1.9V49h-1.9a1,1,0,0,0,0,2h.934a2.966,2.966,0,0,0-.184,1,3,3,0,0,0,3,3h23A3,3,0,0,0,46.5,52ZM32,11a1.5,1.5,0,1,1-1.5,1.5A1.5,1.5,0,0,1,32,11Zm0,5a10.525,10.525,0,0,1,8.94,5H23.073A10.531,10.531,0,0,1,32,16ZM43.5,53h-23a1,1,0,0,1,0-2h23a1,1,0,0,1,0,2ZM20.647,49V27H43.353V49ZM43.5,25h-23a1,1,0,0,1,0-2h23a1,1,0,0,1,0,2Z"/></g></svg>
            </div>
            <span>Banom</span>
          </a>
        </li>
        <li class="nav-heading">programs</li>
         <li class="nav-item">
          <a class="nav-link {{ Request::is('admin/sadesha') ? 'active':'' }}" href="/admin/sadesha">
            <div class="icon-nav">
              <?xml version="1.0" ?><svg height="25" width="25" data-name="Layer 1" id="Layer_1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><title/><path d="M32,49.33a1.49,1.49,0,0,1-.85-.26,17.6,17.6,0,0,0-4.28-2.14A19.6,19.6,0,0,0,22.45,46a15.76,15.76,0,0,1-5.23-1.27,15.14,15.14,0,0,1-4.91-3.68,1.5,1.5,0,0,1-.39-1V18.86a1.5,1.5,0,0,1,2.37-1.23,15.51,15.51,0,0,0,4.24,2.12,19.33,19.33,0,0,0,5.53.79c2.29.09,4.45.17,6.54,1.77A7.69,7.69,0,0,1,33.5,28.4V47.83a1.5,1.5,0,0,1-1.5,1.5ZM14.92,39.5A11.91,11.91,0,0,0,18.47,42a12.92,12.92,0,0,0,4.31,1,22.36,22.36,0,0,1,5.05,1,20.36,20.36,0,0,1,2.66,1.12V28.4a4.66,4.66,0,0,0-1.71-3.69c-1.35-1-2.82-1.09-4.84-1.17a22.12,22.12,0,0,1-6.33-.93,18.18,18.18,0,0,1-2.69-1.1Z"/><path d="M32,49.33a1.5,1.5,0,0,1-1.5-1.5V28.4a7.68,7.68,0,0,1,2.88-6.06c2.12-1.63,4.28-1.71,6.57-1.79a19.33,19.33,0,0,0,5.53-.79,15.51,15.51,0,0,0,4.24-2.12,1.5,1.5,0,0,1,2.37,1.23V40.09a1.5,1.5,0,0,1-.39,1,15.14,15.14,0,0,1-4.91,3.68A15.76,15.76,0,0,1,41.55,46a19.6,19.6,0,0,0-4.43.89,17.6,17.6,0,0,0-4.28,2.14A1.49,1.49,0,0,1,32,49.33ZM49.08,21.51a18.18,18.18,0,0,1-2.69,1.1,22.12,22.12,0,0,1-6.33.93c-2,.08-3.49.13-4.82,1.15A4.67,4.67,0,0,0,33.5,28.4v16.8a20.36,20.36,0,0,1,2.66-1.12,22.36,22.36,0,0,1,5.05-1,12.92,12.92,0,0,0,4.31-1,11.91,11.91,0,0,0,3.55-2.55Z"/><path d="M32,54.5a17.31,17.31,0,0,1-3.92-.45c-1.47-.34-2.92-.71-4.31-1.1a70.12,70.12,0,0,1-10.31-3.48,53.84,53.84,0,0,1-5.2-2.63,1.5,1.5,0,0,1-.75-1.3V27.69A1.5,1.5,0,0,1,9.77,26.4,19.58,19.58,0,0,0,13.12,28a1.5,1.5,0,1,1-1,2.82q-.81-.29-1.6-.65V44.68c1.34.74,2.73,1.43,4.16,2.06a67.74,67.74,0,0,0,9.9,3.33c1.36.37,2.77.73,4.2,1.07a14.48,14.48,0,0,0,6.49,0c1.43-.33,2.84-.69,4.19-1.07a67.68,67.68,0,0,0,9.91-3.33c1.43-.63,2.82-1.32,4.16-2.06V30.15q-.79.35-1.6.65a1.5,1.5,0,1,1-1-2.82,19.58,19.58,0,0,0,3.35-1.58,1.5,1.5,0,0,1,2.27,1.29V45.55a1.5,1.5,0,0,1-.75,1.3,53.84,53.84,0,0,1-5.2,2.63A70.06,70.06,0,0,1,40.23,53c-1.39.38-2.84.75-4.31,1.1A17.32,17.32,0,0,1,32,54.5Z"/><path d="M32,16.5a4.5,4.5,0,0,1,0-9,1.5,1.5,0,0,1,0,3,1.5,1.5,0,1,0,1.42,2,1.5,1.5,0,0,1,2.83,1A4.51,4.51,0,0,1,32,16.5Z"/><path d="M9,52.5a1.5,1.5,0,0,1-.75-2.8l5.05-2.89a1.5,1.5,0,0,1,1.49,2.6L9.75,52.3A1.49,1.49,0,0,1,9,52.5Z"/><path d="M56,52.5a1.49,1.49,0,0,1-.74-.2L50.2,49.41a1.5,1.5,0,0,1,1.49-2.6l5.05,2.89A1.5,1.5,0,0,1,56,52.5Z"/></svg>
            </div>
            <span>Sadesha</span>
          </a>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link active collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
