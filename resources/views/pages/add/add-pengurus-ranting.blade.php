                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control"  id="namaBanom">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="nikBanom" class="form-label">NIK</label>
                                            <input type="text" class="form-control" name="nikBanom" id="nikBanom">
                                        </div>
                                        <div class="col-lg-3">
                                            <label for="posisiPengurusSyuriah" class="form-label">Posisi Pengurus</label>
                                            <select class="form-select" id="posisiPengurusBanom" name="posisiPengurusBanom" >
                                                <option></option>
                                        ...
                                        <div class="col-lg-3 gap-2 d-flex align-items-end">
                                            <button class="btn btn-primary" id="addBanom" type="button"><i class="bi bi-check-circle"></i></button>
                                        </div>
                                    </div>

                                    <div class="row" id="banomForm"></div>
...
@section('js-page')
        ...
        <script>
           ...
           document.getElementById('addBanom').onclick = function () {
               // ajax request
               const url = document.getElementById("urlAddPengurus").value;
               const data = {
                   nik: document.getElementById("nikBanom").value,
                   nama: document.getElementById("namaBanom").value,
                   id_sk: document.getElementById("idSk").value,
                   jabatan: document.getElementById("posisiPengurusBanom").value,
                   jenis_pengurus: 'Ranting'
               }
               const options = {
                   formType:"banom",
                   eventType:"add",
           ...
           const createBanom = (data,token) => {
               ...
               const banomForm = document.getElementById("banomForm");
               const newIndex = `index-banom-${index}`;
               ...
               // Append the new elements to the form
               banomForm.appendChild(nama);
               banomForm.appendChild(nik);
               banomForm.appendChild(deleteButtonContainer);
               ...
               document.getElementById("nikBanom").value = "";
               document.getElementById("namaBanom").value = "";
           };
