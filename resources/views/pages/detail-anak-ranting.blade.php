  ...
  <div class="card">
    <div class="filter">
      ...
      <ul
        ...
        <li><a class="dropdown-item" href="edit-anak-ranting"><i class="bi bi-pencil-square"></i>Edit</a></li>
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <dd>Anak Ranting Lembur Luhur</dd>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3">
        ...
        <div class="col-lg-9">
          <dd>
           Kp. Lembur Luhur Ds Sukaharja Kec. Sariwangi
          </dd>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <dd><a href="">Ranting Sukaharja</a></dd>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3">
